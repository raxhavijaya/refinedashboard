  ...
  return (
    ...
    >
      ...
      <Stack direction="column" justifyContent="space-between" flex={1} gap={{ xs: 4, sm: 2 }}>
        <Stack gap={0.5} direction="column" flexWrap="wrap" alignItems="flex-start">
          <Typography fontSize={22} fontWeight={600} color="#11142d">
            {name}
          </Typography>
          <Typography fontSize={14} color="#11142d">Real-Estate Agent</Typography>
        </Stack>
        <Stack direction="row" flexWrap="wrap" justifyContent="space-between" alignItems="center" gap={2}>
          ...
          <InfoBar icon={<Phone sx={{ color: "#808191" }} />} name="+628-1921-2568" />
