  ...
  return (
    <Box>
      ...
      <Box mt="20px" display="flex" flexWrap="wrap" gap={4}>
        <PieChart title="Properties for Sale" value={684} series={[75, 25]} colors={["#008000", "#e4e8ef"]} />
        <PieChart title="Properties for Rent" value={550} series={[60, 40]} colors={["#da70d6", "#e4e8ef"]} />
        <PieChart title="Total Customers" value={5684} series={[75, 25]} colors={["#ffd700", "#e4e8ef"]} />
        <PieChart title="Properties for Cities" value={555} series={[75, 25]} colors={["#dc143c", "#e4e8ef"]} />
      </Box>
